...
import { getHooksFileName, getAdapterOutputDir } from './svelteConfig.js';
...
export { VIRTUAL_GLOBAL_VALUES_FILE, getGlobalValueInjectionCode, makeGlobalValuesInjectionPlugin };
