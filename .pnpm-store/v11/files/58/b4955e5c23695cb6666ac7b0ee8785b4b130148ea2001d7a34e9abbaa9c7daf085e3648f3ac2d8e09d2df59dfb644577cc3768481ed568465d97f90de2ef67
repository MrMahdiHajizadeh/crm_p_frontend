import { defineIntegration, rewriteFramesIntegration as rewriteFramesIntegration$1, GLOBAL_OBJ, escapeStringForRegex, join, basename } from '@sentry/core';
import { WRAPPED_MODULE_SUFFIX } from '../../common/utils.js';
...
function rewriteFramesIteratee(frame) {
  ...
  const globalWithSentryValues = GLOBAL_OBJ;
...
export { customRewriteFramesIntegration, rewriteFramesIntegration, rewriteFramesIteratee };
