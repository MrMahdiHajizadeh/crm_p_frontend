import { makeAutoInstrumentationPlugin } from './autoInstrument.js';
import { detectAdapter } from './detectAdapter.js';
import { makeGlobalValuesInjectionPlugin } from './injectGlobalValues.js';
import { makeCustomSentryVitePlugins } from './sourceMaps.js';
import { loadSvelteConfig } from './svelteConfig.js';
...
export { generateVitePluginOptions, sentrySvelteKit };
